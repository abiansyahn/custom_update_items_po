...
def update_child_qty_rate(parent_doctype, trans_items, parent_doctype_name, child_docname="items"):
	...
	for d in data:
		...
		if not d.get("docname"):
			...
			prev_item_name, new_item_name = child_item.get("item_name"), d.get("item_name")
			...
			item_name_unchanged = prev_item_name == new_item_name
		...
		if d.get("item_name"):
			child_item.item_name = d.get("item_name")
